...
public class TabelUser extends javax.swing.JPanel {
    ...
    public void Init() {
        myCollection = DBConnector.userCollection;
    }
    ...
    private void createTableModel() {
        ...
        new_model.addColumn("Nama Pengguna");
        new_model.addColumn("Level");
    ...
    private ArrayList<Object[]> getData() {
        ...
        while (iterator.hasNext()) {
            ...
            row.add(doc.getString("username"));
            row.add(doc.getString("level"));
